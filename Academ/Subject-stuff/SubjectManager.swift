...
class SubjectManager: ObservableObject {
    @Published var subjects: [Subject] = [Subject(name: "Mathematics", assessments: [Assessment(name: "WA1", percentageValue: 10, totalMarks: 20, examDone: true, markAttained: 12, examDate: Date(), targetMarks: 0, haveReminder: false, reminder: Date())],credits: 0)] {
        didSet {
            save()
        }
    }
